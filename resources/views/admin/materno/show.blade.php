...
<div class="box box-primary">
    ...
    <div class="box-header with-border">
        <div class="pull-right">
            ...
            <div class="form-group">
                <input name="e_establecimiento" id="e_establecimiento" value="@foreach($e_establecimiento as $e){{ $e->NOM_EESS }}@endforeach" style="visibility:hidden;width:1px;" />
            </div>
