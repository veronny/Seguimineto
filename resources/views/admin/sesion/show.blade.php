@extends('adminlte::page') @section('title', 'sesion') @section('content_header')
<h1>Niñ@s de 6 y 8 meses cuyas madres al menos participaron una sesion demostrativo</h1>

<ol class="breadcrumb ">
    <li><a href="">Principal</a></a>
    </li>
    <li><a href="">sesiones demostrativas</a>
    </li>
</ol>
...
<div class="box box-primary">
    <div class="box-header with-border">
        <div class="pull-left">
            ...
            <div class="btn-group" style="margin-right: 5px">
                {{ Form::open(['route' => 'admin.sesion.show','method' => 'GET', 'class' => 'form-inline pull-left' ]) }}
    ...
    <div class="box-header with-border">
        <div class="pull-right">
            {{ Form::open(['route' => 'admin.sesion.show.excel','method' => 'GET', 'class' => 'form-inline pull-left' ]) }}
            <div class="form-group">
        ...
        <!-- PDF NO CUMPLEN -->
        <div class="pull-right">
            {{ Form::open(['route' => 'admin.sesion.reporte','method' => 'GET', 'class' => 'form-inline pull-left' ]) }}
            <div class="form-group">
                <input name="e_anno" id="e_anno" value="@foreach($e_anno as $a){{ $a->ANNO }}@endforeach" style="visibility:hidden;width:1px;" />
            </div>
            <div class="form-group">
            ...
            <table id="dt_indicador" class="table table-striped table-hover" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th>F. Nac</th>
                        <th>F. Inicio</th>
                        <th><font color="#2E8B57">Fecha Sesion</th>
                        <th><font color="#2E8B57">Edad Sesion</th>
                        <th>Fecha Fin</th>
                        <th>Indicador</th>
                        <th><font color="#4272A6">Nombre EESS</th>
                        <th><font color="#4272A6">Distrito</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        @else
                        <td><font color="#FF0000">{{ $s->edad_dias_HIS }}</font></td>
                        @endif  
