...
<ol class="breadcrumb" style="margin-right: 30px;">
    ...
    <li><a href="#">FED</a></li>
    <li><a href="#">visitas 8 meses</a></li>
</ol>
@stop
    ...
    <div class="col-md-8">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <div class="box-tools">                       
                        {{ Form::open(['route' => 'admin.visita_tratamiento.index','method' => 'GET', 'class' => 'form-inline pull-right' ]) }}
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <div class="box-tools">
                        <td width="10px">
                            <a href="{{ route('admin.visita_tratamiento.show') }}" class="btn btn-warning">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Avance por Distritos</h3>
                    <div class="box-tools pull-right">
                        {{ Form::open(['route' => 'admin.visita_tratamiento.excel','method' => 'GET', 'class' => 'form-inline pull-right' ]) }}
                        <div class="form-group">                                
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Avance por Micro Redes</h3>
                    <div class="box-tools pull-right">
                        {{ Form::open(['route' => 'admin.visita_tratamiento.excel.microred','method' => 'GET', 'class' => 'form-inline pull-right' ]) }}
                        <div class="form-group">                                
                            <input name="r_anno" id="r_anno" value="@foreach($r_anno as $r){{ $r->ANNO }}@endforeach" style="visibility:hidden;width:1px;heigth:1px" />
                        </div>
                        <div class="form-group">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Avance por Establecimientos</h3>
                    <div class="box-tools pull-right">
                        <div class="box-tools pull-right">
                            {{ Form::open(['route' => 'admin.visita_tratamiento.excel.establecimiento','method' => 'GET', 'class' => 'form-inline pull-right' ]) }}
                            <div class="form-group">                                
                                <input name="r_anno" id="r_anno" value="@foreach($r_anno as $r){{ $r->ANNO }}@endforeach" style="visibility:hidden;width:1px;heigth:1px" />
                            </div>
                            <div class="form-group">
