...
use App\Exports\InicioExportEstablecimiento;
use App\Exports\InicioExportMicrored;
use App\Exports\InicioDetalleExport;
...
class InicioController extends Controller
{
    Public function index(Request $request)
    {
        ...
        $r_anno =  DB::table('indicador_inicio')
                        ->select('ANNO')
                        ->where('ANNO','=',$anno)
                        ->groupBy('ANNO')
                        ->get();
        
        $r_mes =  DB::table('indicador_inicio')
                        ->select('MES')
                        ->where('MES','=',$mes)
                        ->groupBy('MES')
                        ->get();
        ...
        // Grafico de Region
        $regionnum = DB::table('indicador_inicio')
                    ->select([
        ...
        $regionden = DB::table('indicador_inicio')
                    ->select([
        ...
        $prov = DB::table('indicador_inicio')
                  ->select([
                          DB::raw('PROVINCIA'),
                          ])
                  ->where('ANNO','=',$anno)
        ...
        $prov_num = DB::table('indicador_inicio')
                        ->select([
        ...
        $prov_den = DB::table('indicador_inicio')
                        ->select([
        ...
        $red_num = DB::table('indicador_inicio')
                        ->select([
        ...
        $red_den = DB::table('indicador_inicio')
                        ->select([
        ...
        // Tabla de Provincia
        $provincia = DB::table('indicador_inicio')
                ->select([
                        'PERIODO',
                        'ANNO',
                        'MES',
        ...
        // Tabla de Distrito
        $distrito = DB::table('indicador_inicio')
                ->select([
                        'PERIODO',
                        'ANNO',
                        'MES',
        ...
        // Tabla de Red
        $redes = DB::table('indicador_inicio')
                ->select([
                        'PERIODO',
                        'ANNO',
                        'MES',
        ...
        // Tabla de MicroRed
        $microred = DB::table('indicador_inicio')
                ->select([
                        'PERIODO',
                        'ANNO',
                        'MES',
        ...
        $establecimiento = DB::table('indicador_inicio')
                ->select([
                        'PERIODO',
                        'ANNO',
                        'MES',
    ...
    public function exportExcel(Request $request)
    {
        ...
        return Excel::download(new InicioExport($anno,$mes),'Inicio-list.xlsx');
    }
    ...
    public function exportExcelMicrored(Request $request)
    {
        ...
        return Excel::download(new InicioExportMicrored($anno,$mes),'Inicio-microred.xlsx');
    }
    ...
    public function exportExcelEstablecimiento(Request $request)
    {
        ...
        return Excel::download(new InicioExportEstablecimiento($anno,$mes),'Inicio-establecimiento.xlsx');
    }
    ...
    {                  
        ...
        // Request Excel
        $e_anno =  DB::table('indicador_inicio')
                ->select('ANNO')
                ->where('ANNO','=',$r_anno)
                ->groupBy('ANNO')
                ->get();

        $e_mes =  DB::table('indicador_inicio')
                ->select('MES')
                ->where('MES','=',$r_mes)
                ->groupBy('MES')
                ->get();
        
        $e_provincia = DB::table('indicador_inicio')
                ->select([DB::raw('PROVINCIA')])
                ->where('PROVINCIA','=',$r_provincia)
                ->groupBy('PROVINCIA')
                ->get();
        
        $e_distrito = DB::table('indicador_inicio')
                ->select([DB::raw('DISTRITO')])
                ->where('DISTRITO','=',$r_distrito)
                ->groupBy('DISTRITO')
                ->get();

        $e_red = DB::table('indicador_inicio')
                ->select([DB::raw('NOMBRE_RED')])
                ->where('NOMBRE_RED','=',$r_red)
                ->groupBy('NOMBRE_RED')
                ->get();
        
        $e_microred = DB::table('indicador_inicio')
                ->select([DB::raw('NOMBRE_MICRORED')])
                ->where('NOMBRE_MICRORED','=',$r_microred)
                ->groupBy('NOMBRE_MICRORED')
                ->get();
        
        $e_establecimiento = DB::table('indicador_inicio')
        ...
        $t_inicio = DB::table('indicador_inicio')
                        ...
                        //dd($t_establec);
        return view('admin.inicio.show',compact('m_anno','m_mes','provincia','distrito','red','microred','establecimiento','t_inicio'))
                        ->with(['e_anno' => $e_anno])
                        ->with(['e_mes' => $e_mes])
    ...
    public function exportExcelDetalle(Request $request)
    {
        ...
        return Excel::download(new InicioDetalleExport($anno,$mes,$provincia,$distrito,$red,$microred,$establecimiento),'Detalle-inicio.xlsx');
    }
