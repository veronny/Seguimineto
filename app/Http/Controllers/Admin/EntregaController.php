...
use App\Exports\EntregaExportEstablecimiento;
use App\Exports\EntregaExportMicrored;
use App\Exports\EntregaDetalleExport;
...
class EntregaController extends Controller
{
    Public function index(Request $request)
    {
        ...
        $r_anno =  DB::table('indicador_12meses')
                        ->select('ANNO')
                        ->where('ANNO','=',$anno)
                        ->groupBy('ANNO')
                        ->get();
        
        $r_mes =  DB::table('indicador_12meses')
                        ->select('MES')
                        ->where('MES','=',$mes)
                        ->groupBy('MES')
                        ->get();
        ...
        // Grafico de Region
        $regionnum = DB::table('indicador_12meses')
                    ->select([
        ...
        $regionden = DB::table('indicador_12meses')
                    ->select([
        ...
        $prov = DB::table('indicador_12meses')
                  ->select([
                          DB::raw('PROVINCIA'),
                          ])
                  ->where('ANNO','=',$anno)
        ...
        $prov_num = DB::table('indicador_12meses')
                        ->select([
        ...
        $prov_den = DB::table('indicador_12meses')
                        ->select([
        ...
        // Grafico de Red
        $red = DB::table('indicador_12meses')
                  ->select([
                          DB::raw('NOMBRE_RED'),
                          ])
                  ->where('ANNO','=',$anno)
        ...
        $red_num = DB::table('indicador_12meses')
                        ->select([
        ...
        $red_den = DB::table('indicador_12meses')
                        ->select([
        ...
        // Tabla de Provincia
        $provincia = DB::table('indicador_12meses')
                ->select([
                        'PERIODO',
                        'ANNO',
                        'MES',
        ...
        // Tabla de Distrito
        $distrito = DB::table('indicador_12meses')
                ->select([
                        'PERIODO',
                        'ANNO',
                        'MES',
        ...
        // Tabla de Red
        $redes = DB::table('indicador_12meses')
                ->select([
                        'PERIODO',
                        'ANNO',
                        'MES',
        ...
        // Tabla de MicroRed
        $microred = DB::table('indicador_12meses')
                ->select([
                        'PERIODO',
                        'ANNO',
                        'MES',
    ...
    public function exportExcel(Request $request)
    {
        ...
        return Excel::download(new EntregaExport($anno,$mes),'Entrega-list.xlsx');
    }
    ...
    public function exportExcelMicrored(Request $request)
    {
        ...
        return Excel::download(new EntregaExportMicrored($anno,$mes),'Entrega-microred.xlsx');
    }
    ...
    public function exportExcelEstablecimiento(Request $request)
    {
        ...
        return Excel::download(new EntregaExportEstablecimiento($anno,$mes),'Entrega-establecimiento.xlsx');
    }
    ...
    {                  
        ...
        // Request Excel
        $e_anno =  DB::table('indicador_12meses')
                ->select('ANNO')
                ->where('ANNO','=',$r_anno)
                ->groupBy('ANNO')
                ->get();

        $e_mes =  DB::table('indicador_12meses')
                ->select('MES')
                ->where('MES','=',$r_mes)
                ->groupBy('MES')
                ->get();
        
        $e_provincia = DB::table('indicador_12meses')
                ->select([DB::raw('PROVINCIA')])
                ->where('PROVINCIA','=',$r_provincia)
                ->groupBy('PROVINCIA')
                ->get();
        
        $e_distrito = DB::table('indicador_12meses')
                ->select([DB::raw('DISTRITO')])
                ->where('DISTRITO','=',$r_distrito)
                ->groupBy('DISTRITO')
                ->get();

        $e_red = DB::table('indicador_12meses')
                ->select([DB::raw('NOMBRE_RED')])
                ->where('NOMBRE_RED','=',$r_red)
                ->groupBy('NOMBRE_RED')
                ->get();
        
        $e_microred = DB::table('indicador_12meses')
        ...
        $t_entrega = DB::table('indicador_12meses')
                        ...
                        //dd($t_establec);
        return view('admin.entrega.show',compact('m_anno','m_mes','provincia','distrito','red','microred','establecimiento','t_entrega'))
                        ->with(['e_anno' => $e_anno])
                        ->with(['e_mes' => $e_mes])
    ...
    public function exportExcelDetalle(Request $request)
    {
        ...
        return Excel::download(new EntregaDetalleExport($anno,$mes,$provincia,$distrito,$red,$microred,$establecimiento),'Detalle-Entrega.xlsx');
    }
