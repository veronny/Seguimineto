...
class ReporteVisitaTratamientoController extends Controller
{
    public function reporte(Request $request)
    {
        ...
        $t_visita_tratamiento = DB::table('indicador_visita_tratamiento')
            ->select([
                'DNI_MENOR',
                                'NOMBRE_COMPLETO',
                                'Fecha_Nacimiento',
        ...
        $date = date("d-m-Y");
        $pdf = PDF::loadView('admin.visita_tratamiento.reporte', compact('t_visita_tratamiento','date'))->setPaper('a4','landscape')->save('myfile.pdf');
